...
const MOD_PROP = {
  ...
  'dmg': [
    ...
    ['R2', { code: 'dmg', min: 20, max: 25 }, { lvl: 55, lvlreq: 35, freq: 2 }, M_ITS.JEW],
    ['R3', { code: 'dmg', min: 15, max: 20 }, { lvl: 40, lvlreq: 25, freq: 2 }, M_ITS.JEW],
    ['R4', { code: 'dmg', min: 10, max: 15 }, { lvl: 25, lvlreq: 15, freq: 2 }, M_ITS.JEW],
    ['R5', { code: 'dmg', min: 5, max: 10 }, { lvl: 15, lvlreq: 10, freq: 2 }, M_ITS.JEW],
    ['R6', { code: 'dmg', min: 3, max: 5 }, { lvl: 10, lvlreq: 5, freq: 2 }, M_ITS.JEW],
    ['R1', { code: 'dmg', min: 20, max: 30 }, { lvl: 75, lvlreq: 45, freq: 2 }, M_ITS.CM3],
    ['R1', { code: 'dmg', min: 15, max: 20 }, { lvl: 65, lvlreq: 45, freq: 2 }, M_ITS.CM3],
    ['R2', { code: 'dmg', min: 10, max: 15 }, { lvl: 55, lvlreq: 35, freq: 2 }, M_ITS.CM32],
    ['R3', { code: 'dmg', min: 5, max: 10 }, { lvl: 40, lvlreq: 25, freq: 2 }, M_ITS.CM32],
  ],
  ...
  'dmg%': [
    ...
    ['R6', { code: 'dmg%', min: 10, max: 10 }, { lvl: 10, lvlreq: 5, freq: 2 }, M_ITS.CM321],
    ['R5', { code: 'dmg%', min: 10, max: 15 }, { lvl: 20, lvlreq: 10, freq: 2 }, M_ITS.CM321],
    ['R4', { code: 'dmg%', min: 10, max: 20 }, { lvl: 40, lvlreq: 20, freq: 2 }, M_ITS.CM32],
    ['R3', { code: 'dmg%', min: 15, max: 25 }, { lvl: 50, lvlreq: 30, freq: 2 }, M_ITS.CM32],
    ['R2', { code: 'dmg%', min: 20, max: 30 }, { lvl: 70, lvlreq: 45, freq: 2 }, M_ITS.CM32],
    ['R1', { code: 'dmg%', min: 30, max: 40 }, { lvl: 85, lvlreq: 65, freq: 2 }, M_ITS.CM3],
    ['R6', { code: 'dmg%', min: 5, max: 10 }, { lvl: 15, lvlreq: 5, freq: 2 }, M_ITS.JEW],
    ['R5', { code: 'dmg%', min: 10, max: 20 }, { lvl: 25, lvlreq: 15, freq: 2 }, M_ITS.JEW],
    ['R4', { code: 'dmg%', min: 20, max: 30 }, { lvl: 40, lvlreq: 30, freq: 2 }, M_ITS.JEW],
    ['R3', { code: 'dmg%', min: 30, max: 40 }, { lvl: 55, lvlreq: 45, freq: 2 }, M_ITS.JEW],
    ['R2', { code: 'dmg%', min: 40, max: 50 }, { lvl: 70, lvlreq: 50, freq: 2 }, M_ITS.JEW],
    ['R1', { code: 'dmg%', min: 50, max: 60 }, { lvl: 85, lvlreq: 65, freq: 2 }, M_ITS.JEW],
  ],
  ...
  'dmg/lvl': [
    ...
    ['R4', { code: 'dmg/lvl', min: 3, max: 4 }, { lvl: 15, lvlreq: 10, freq: 2 }, M_ITS.CM3],
    ['R3', { code: 'dmg/lvl', min: 4, max: 5 }, { lvl: 35, lvlreq: 20, freq: 2 }, M_ITS.CM3],
    ['R2', { code: 'dmg/lvl', min: 5, max: 6 }, { lvl: 60, lvlreq: 40, freq: 2 }, M_ITS.CM3],
    ['R1', { code: 'dmg/lvl', min: 6, max: 8 }, { lvl: 85, lvlreq: 60, freq: 2 }, M_ITS.CM3],
    ['R4', { code: 'dmg/lvl', min: 3, max: 4 }, { lvl: 15, lvlreq: 9, freq: 2 }, M_ITS.JEW],
    ['R3', { code: 'dmg/lvl', min: 4, max: 5 }, { lvl: 35, lvlreq: 20, freq: 2 }, M_ITS.JEW],
    ['R2', { code: 'dmg/lvl', min: 5, max: 6 }, { lvl: 60, lvlreq: 40, freq: 2 }, M_ITS.JEW],
    ['R1', { code: 'dmg/lvl', min: 6, max: 8 }, { lvl: 85, lvlreq: 60, freq: 2 }, M_ITS.JEW],
  ],
  'dmg-undead': [
