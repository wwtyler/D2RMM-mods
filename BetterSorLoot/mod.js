...
const MOD_PROP = {
  ...
  'dmg': [
    ...
    ['R3', { code: 'dmg', min: 5, max: 10 }, { lvl: 40, lvlreq: 25, freq: 4 }, M_ITS.CM32],
  ],
  ...
  'dmg/lvl': [
    ['R4', { code: 'dmg/lvl', min: 8, max: 12 }, { lvl: 15, lvlreq: 9, freq: 3 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R3', { code: 'dmg/lvl', min: 12, max: 16 }, { lvl: 35, lvlreq: 20, freq: 3 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R2', { code: 'dmg/lvl', min: 16, max: 20 }, { lvl: 60, lvlreq: 40, freq: 3 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R1', { code: 'dmg/lvl', min: 20, max: 24 }, { lvl: 85, lvlreq: 60, freq: 3 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R4', { code: 'dmg/lvl', min: 5, max: 5 }, { lvl: 15, lvlreq: 10, freq: 3 }, M_ITS.CM32],
    ['R3', { code: 'dmg/lvl', min: 8, max: 8 }, { lvl: 35, lvlreq: 20, freq: 3 }, M_ITS.CM3],
    ['R2', { code: 'dmg/lvl', min: 10, max: 10 }, { lvl: 60, lvlreq: 40, freq: 3 }, M_ITS.CM3],
    ['R1', { code: 'dmg/lvl', min: 12, max: 12 }, { lvl: 85, lvlreq: 60, freq: 3 }, M_ITS.CM3],
    ['R4', { code: 'dmg/lvl', min: 4, max: 6 }, { lvl: 15, lvlreq: 9, freq: 3 }, M_ITS.JEW],
    ['R3', { code: 'dmg/lvl', min: 5, max: 8 }, { lvl: 35, lvlreq: 20, freq: 3 }, M_ITS.JEW],
    ['R2', { code: 'dmg/lvl', min: 6, max: 10 }, { lvl: 60, lvlreq: 40, freq: 3 }, M_ITS.JEW],
    ['R1', { code: 'dmg/lvl', min: 8, max: 12 }, { lvl: 85, lvlreq: 60, freq: 3 }, M_ITS.JEW],
  ],
  'dmg-undead': [
  ...
  'super-str': [
    ...
    ['R3', { code: 'str', min: 12, max: 16 }, { lvl: 40, lvlreq: 25, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM32_JEW)],
  ...
  'super-vit': [
    ...
    ['R3', { code: 'vit', min: 12, max: 16 }, { lvl: 40, lvlreq: 25, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM32_JEW)],
  ...
  'super-dex': [
    ...
    ['R3', { code: 'dex', min: 12, max: 16 }, { lvl: 40, lvlreq: 25, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM32_JEW)],
  ...
  'super-enr': [
    ...
    ['R3', { code: 'enr', min: 12, max: 16 }, { lvl: 40, lvlreq: 25, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM32_JEW)],
