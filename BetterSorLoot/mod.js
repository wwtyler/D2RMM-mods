...
const M_ITS = {
  ...
  AMA_ONLY: ['amaz', 'spea', 'miss', 'circ'],
  SOR: ['sorc', 'orb', 'staff', 'amul', 'circ', 'ring', 'glov'],
  SOR_ONLY: ['sorc', 'orb', 'staff', 'circ'],
  ...
  PAL_ONLY: ['pala', 'scep', 'ashd', 'circ'],
  BAR: ['barb', 'phlm', 'axe', 'tkni', 'spea', 'helm', 'amul'],
  BAR_ONLY: ['barb', 'phlm', 'tkni', 'circ'],
  DRU: ['drui', 'club', 'pelt', 'amul', 'circ'],
  DRU_ONLY: ['drui', 'club', 'pelt', 'circ'],
  ASS: ['assn', 'h2h', 'helm', 'amul', 'circ'],
  ASS_ONLY: ['assn', 'h2h', 'circ'],
...
const MOD_PROP = {
  ...
  'allskills': [
    ...
    ['R2', { code: 'allskills', min: 1, max: 1 }, { lvl: 75, lvlreq: 45, freq: 1 }, M_ITS.NORMAL],
    ['R1', { code: 'allskills', min: 1, max: 2 }, { lvl: 85, lvlreq: 65, freq: 1, magic: 1 }, M_ITS.NORMAL],
    ...
    ['R1', { code: 'allskills', min: 2, max: 3 }, { lvl: 85, lvlreq: 65, freq: 1, magic: 1 }, M_ITS.SOR_ONLY],
    ...
    ['R1', { code: 'allskills', min: 2, max: 3 }, { lvl: 85, lvlreq: 65, freq: 1, magic: 1 }, M_ITS.PAL_ONLY],
    ...
    ['R1', { code: 'allskills', min: 2, max: 3 }, { lvl: 85, lvlreq: 65, freq: 1, magic: 1 }, M_ITS.NEC_ONLY],
  ],
  // ['clz-skill', MOD_TYPE.BOTH, '角色技能']
  'clz-skill': [
    ['R2', { code: 'sor', min: 1, max: 1 }, { lvl: 75, lvlreq: 45, freq: 1 }, M_ITS.SOR_ONLY],
    ['R1', { code: 'sor', min: 1, max: 2 }, { lvl: 85, lvlreq: 45, freq: 1 }, M_ITS.SOR_ONLY],
    ['R1', { code: 'sor', min: 2, max: 3 }, { lvl: 80, lvlreq: 65, freq: 1, magic: 1 }, M_ITS.SOR_ONLY],
    ['R2', { code: 'pal', min: 1, max: 1 }, { lvl: 75, lvlreq: 45, freq: 1 }, M_ITS.PAL_ONLY],
    ['R1', { code: 'pal', min: 1, max: 2 }, { lvl: 85, lvlreq: 45, freq: 1 }, M_ITS.PAL_ONLY],
    ['R1', { code: 'pal', min: 2, max: 3 }, { lvl: 80, lvlreq: 65, freq: 1, magic: 1 }, M_ITS.PAL_ONLY],
    ['R2', { code: 'nec', min: 1, max: 1 }, { lvl: 75, lvlreq: 45, freq: 1 }, M_ITS.NEC_ONLY],
    ['R1', { code: 'nec', min: 1, max: 2 }, { lvl: 85, lvlreq: 45, freq: 1 }, M_ITS.NEC_ONLY],
    ['R1', { code: 'nec', min: 2, max: 3 }, { lvl: 80, lvlreq: 65, freq: 1, magic: 1 }, M_ITS.NEC_ONLY],
    ['R2', { code: 'bar', min: 1, max: 1 }, { lvl: 75, lvlreq: 45, freq: 1 }, M_ITS.BAR_ONLY],
    ['R1', { code: 'bar', min: 1, max: 2 }, { lvl: 85, lvlreq: 45, freq: 1 }, M_ITS.BAR_ONLY],
    ['R1', { code: 'bar', min: 2, max: 3 }, { lvl: 80, lvlreq: 65, freq: 1, magic: 1 }, M_ITS.BAR_ONLY],
    ['R2', { code: 'ama', min: 1, max: 1 }, { lvl: 75, lvlreq: 45, freq: 1 }, M_ITS.AMA_ONLY],
    ['R1', { code: 'ama', min: 1, max: 2 }, { lvl: 85, lvlreq: 45, freq: 1 }, M_ITS.AMA_ONLY],
    ['R1', { code: 'ama', min: 2, max: 3 }, { lvl: 80, lvlreq: 65, freq: 1, magic: 1 }, M_ITS.AMA_ONLY],
    ['R2', { code: 'ass', min: 1, max: 1 }, { lvl: 75, lvlreq: 45, freq: 1 }, M_ITS.ASS_ONLY],
    ['R1', { code: 'ass', min: 1, max: 2 }, { lvl: 85, lvlreq: 45, freq: 1 }, M_ITS.ASS_ONLY],
    ['R1', { code: 'ass', min: 2, max: 3 }, { lvl: 80, lvlreq: 65, freq: 1, magic: 1 }, M_ITS.ASS_ONLY],
    ['R2', { code: 'dru', min: 1, max: 1 }, { lvl: 75, lvlreq: 45, freq: 1 }, M_ITS.DRU_ONLY],
    ['R1', { code: 'dru', min: 1, max: 2 }, { lvl: 85, lvlreq: 45, freq: 1 }, M_ITS.DRU_ONLY],
    ['R1', { code: 'dru', min: 2, max: 3 }, { lvl: 80, lvlreq: 65, freq: 1, magic: 1 }, M_ITS.DRU_ONLY],
  ],
  ...
  'super-magic': [
    ...
    ['R5', { code: 'mag%/lvl', min: 1, max: 2 }, { lvl: 12, lvlreq: 5, freq: 2 }, M_ITS.NORMAL],
    ['R4', { code: 'mag%/lvl', min: 2, max: 3 }, { lvl: 20, lvlreq: 10, freq: 2 }, M_ITS.NORMAL],
    ['R3', { code: 'mag%/lvl', min: 3, max: 4 }, { lvl: 30, lvlreq: 20, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'mag%/lvl', min: 4, max: 5 }, { lvl: 40, lvlreq: 30, freq: 2 }, M_ITS.NORMAL],
    ['R1', { code: 'mag%/lvl', min: 5, max: 6 }, { lvl: 60, lvlreq: 40, freq: 2 }, M_ITS.NORMAL],
  ...
  'skillboost': [
    ...
    ['attskill', { code: 'att-skill', param: 53, min: 15, max: 20 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.WEAP, M_ETS.MAGIC_STAFF],
    ['attskill', { code: 'att-skill', param: 'Frozen Orb', min: 16, max: 22 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.WEAP, M_ETS.MAGIC_STAFF],
    ['attskill', { code: 'att-skill', param: 'Glacial Spike', min: 25, max: 23 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.WEAP, M_ETS.MAGIC_STAFF],
    ['attskill', { code: 'att-skill', param: 'Nova', min: 15, max: 24 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.WEAP, M_ETS.MAGIC_STAFF],
    ['attskill', { code: 'att-skill', param: 'Charged Bolt', min: 20, max: 25 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.WEAP, M_ETS.MAGIC_STAFF],
    ...
    ['hitskill', { code: 'hit-skill', param: 'Tornado', min: 12, max: 15 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.ARMO, M_ETS.MAGIC_STAFF],
    ['hitskill', { code: 'hit-skill', param: 'Bone Spear', min: 15, max: 10 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.ARMO, M_ETS.MAGIC_STAFF],
    ['hitskill', { code: 'hit-skill', param: 'Frozen Orb', min: 9, max: 33 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.ARMO, M_ETS.MAGIC_STAFF],
    ['hitskill', { code: 'hit-skill', param: 'Charged Bolt', min: 11, max: 19 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.ARMO, M_ETS.MAGIC_STAFF],
    ...
    ['oskill', { code: 'oskill', param: 'Guided Arrow', min: 3, max: 8 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.CASTER],
    ['oskill', { code: 'oskill', param: 'Critical Strike', min: 3, max: 8 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.CASTER],
    ['oskill', { code: 'oskill', param: 'Hydra', min: 10, max: 15 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.CASTER],
    ...
    ['oskill', { code: 'oskill', param: 'Teleport', min: 1, max: 5 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.CASTER],
    ['oskill', { code: 'oskill', param: 'Warmth', min: 5, max: 8 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.CASTER],
    ['oskill', { code: 'oskill', param: 'Zeal', min: 1, max: 5 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.CASTER],
    ...
    ['aura', { code: 'aura', param: 'Might', min: 5, max: 10 }, { lvl: 75, lvlreq: 50, freq: 1 }, M_ITS.NORMAL],
    ['aura', { code: 'aura', param: 'Redemption', min: 4, max: 10 }, { lvl: 75, lvlreq: 50, freq: 1 }, M_ITS.NORMAL],
    ['aura', { code: 'aura', param: 'Sanctuary', min: 8, max: 14 }, { lvl: 75, lvlreq: 50, freq: 1 }, M_ITS.NORMAL],
    ['aura', { code: 'aura', param: 'Fanaticism', min: 4, max: 8 }, { lvl: 75, lvlreq: 50, freq: 1 }, M_ITS.NORMAL],
    ['aura', { code: 'aura', param: 'Meditation', min: 4, max: 10 }, { lvl: 75, lvlreq: 50, freq: 1 }, M_ITS.NORMAL],
    ['aura', { code: 'aura', param: 'Thorns', min: 12, max: 17 }, { lvl: 75, lvlreq: 50, freq: 1 }, M_ITS.NORMAL],
    ['aura', { code: 'aura', param: 'Salvation', min: 3, max: 8 }, { lvl: 75, lvlreq: 50, freq: 1 }, M_ITS.NORMAL],
    ['aura', { code: 'aura', param: 'Conviction', min: 2, max: 6 }, { lvl: 75, lvlreq: 50, freq: 1 }, M_ITS.NORMAL],
  ],
  ...
  'sor-mastery': [
    ...
    ['BLIZZARD-R1', { code: 'skill', param: 'Blizzard', min: 4, max: 6 }, { lvl: 85, lvlreq: 65, freq: 2, magic: 1 }, M_ITS.SOR_ONLY],
    ...
    ['FrozenOrb-R1', { code: 'skill', param: 'Frozen Orb', min: 4, max: 6 }, { lvl: 85, lvlreq: 65, freq: 2, magic: 1 }, M_ITS.SOR_ONLY],
    ...
    ['GlacialSpike-R1', { code: 'skill', param: 'Glacial Spike', min: 4, max: 6 }, { lvl: 85, lvlreq: 65, freq: 2, magic: 1 }, M_ITS.SOR_ONLY],
    ...
    ['Nova-R1', { code: 'skill', param: 'Nova', min: 4, max: 6 }, { lvl: 85, lvlreq: 65, freq: 2, magic: 1 }, M_ITS.SOR_ONLY],
    ...
    ['ChainLightning-R1', { code: 'skill', param: 'Chain Lightning', min: 4, max: 6 }, { lvl: 85, lvlreq: 65, freq: 2, magic: 1 }, M_ITS.SOR_ONLY],
    ...
    ['Hydra-R1', { code: 'skill', param: 'Hydra', min: 4, max: 6 }, { lvl: 85, lvlreq: 65, freq: 2, magic: 1 }, M_ITS.SOR_ONLY],
    ...
    ['FireBall-R1', { code: 'skill', param: 'Fire Ball', min: 4, max: 6 }, { lvl: 85, lvlreq: 65, freq: 2, magic: 1 }, M_ITS.SOR_ONLY],
    ...
    ['Meteor-R1', { code: 'skill', param: 'Meteor', min: 4, max: 6 }, { lvl: 85, lvlreq: 65, freq: 2, magic: 1 }, M_ITS.SOR_ONLY],
    ...
    ['FireWall-R1', { code: 'skill', param: 'Fire Wall', min: 4, max: 6 }, { lvl: 85, lvlreq: 65, freq: 2, magic: 1 }, M_ITS.SOR_ONLY],
  ],
  'skill-rand': [
  ...
  'dmg': [
    ...
    ['R2', { code: 'dmg', min: 25, max: 35 }, { lvl: 55, lvlreq: 35, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R3', { code: 'dmg', min: 20, max: 25 }, { lvl: 40, lvlreq: 25, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R4', { code: 'dmg', min: 15, max: 20 }, { lvl: 25, lvlreq: 15, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R5', { code: 'dmg', min: 10, max: 15 }, { lvl: 15, lvlreq: 10, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R6', { code: 'dmg', min: 5, max: 10 }, { lvl: 10, lvlreq: 5, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R1', { code: 'dmg', min: 25, max: 30 }, { lvl: 75, lvlreq: 50, freq: 1 }, M_ITS.JEW],
    ['R2', { code: 'dmg', min: 20, max: 25 }, { lvl: 55, lvlreq: 35, freq: 1 }, M_ITS.JEW],
    ['R3', { code: 'dmg', min: 15, max: 20 }, { lvl: 40, lvlreq: 25, freq: 1 }, M_ITS.JEW],
    ['R4', { code: 'dmg', min: 10, max: 15 }, { lvl: 25, lvlreq: 15, freq: 1 }, M_ITS.JEW],
    ['R5', { code: 'dmg', min: 5, max: 10 }, { lvl: 15, lvlreq: 10, freq: 1 }, M_ITS.JEW],
    ['R6', { code: 'dmg', min: 3, max: 5 }, { lvl: 10, lvlreq: 5, freq: 1 }, M_ITS.JEW],
    ['R1', { code: 'dmg', min: 20, max: 30 }, { lvl: 75, lvlreq: 45, freq: 1 }, M_ITS.CM3],
    ['R1', { code: 'dmg', min: 15, max: 20 }, { lvl: 65, lvlreq: 45, freq: 1 }, M_ITS.CM3],
    ['R2', { code: 'dmg', min: 10, max: 15 }, { lvl: 55, lvlreq: 35, freq: 1 }, M_ITS.CM32],
    ['R3', { code: 'dmg', min: 5, max: 10 }, { lvl: 40, lvlreq: 25, freq: 1 }, M_ITS.CM32],
  ],
  // ['dmg%', MOD_TYPE.SUFFIX, '攻击%'],
  'dmg%': [
    ['R6', { code: 'dmg%', min: 10, max: 20 }, { lvl: 10, lvlreq: 5, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R5', { code: 'dmg%', min: 20, max: 35 }, { lvl: 25, lvlreq: 15, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R4', { code: 'dmg%', min: 30, max: 45 }, { lvl: 40, lvlreq: 25, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R3', { code: 'dmg%', min: 40, max: 60 }, { lvl: 55, lvlreq: 35, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R2', { code: 'dmg%', min: 60, max: 80 }, { lvl: 70, lvlreq: 50, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R1', { code: 'dmg%', min: 80, max: 100 }, { lvl: 85, lvlreq: 65, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R6', { code: 'dmg%', min: 10, max: 10 }, { lvl: 10, lvlreq: 5, freq: 1 }, M_ITS.CM321],
    ['R5', { code: 'dmg%', min: 10, max: 15 }, { lvl: 20, lvlreq: 10, freq: 1 }, M_ITS.CM321],
    ['R4', { code: 'dmg%', min: 10, max: 20 }, { lvl: 40, lvlreq: 20, freq: 1 }, M_ITS.CM32],
    ['R3', { code: 'dmg%', min: 15, max: 25 }, { lvl: 50, lvlreq: 30, freq: 1 }, M_ITS.CM32],
    ['R2', { code: 'dmg%', min: 20, max: 30 }, { lvl: 70, lvlreq: 45, freq: 1 }, M_ITS.CM32],
    ['R1', { code: 'dmg%', min: 30, max: 40 }, { lvl: 85, lvlreq: 65, freq: 1 }, M_ITS.CM3],
    ['R6', { code: 'dmg%', min: 5, max: 10 }, { lvl: 15, lvlreq: 5, freq: 1 }, M_ITS.JEW],
    ['R5', { code: 'dmg%', min: 10, max: 20 }, { lvl: 25, lvlreq: 15, freq: 1 }, M_ITS.JEW],
    ['R4', { code: 'dmg%', min: 20, max: 30 }, { lvl: 40, lvlreq: 30, freq: 1 }, M_ITS.JEW],
    ['R3', { code: 'dmg%', min: 30, max: 40 }, { lvl: 55, lvlreq: 45, freq: 1 }, M_ITS.JEW],
    ['R2', { code: 'dmg%', min: 40, max: 50 }, { lvl: 70, lvlreq: 50, freq: 1 }, M_ITS.JEW],
    ['R1', { code: 'dmg%', min: 50, max: 60 }, { lvl: 85, lvlreq: 65, freq: 1 }, M_ITS.JEW],
  ],
  // ['dmg/lvl', MOD_TYPE.SUFFIX, '攻击/等级'],
  'dmg/lvl': [
    ['R4', { code: 'dmg/lvl', min: 6, max: 8 }, { lvl: 15, lvlreq: 9, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R3', { code: 'dmg/lvl', min: 8, max: 10 }, { lvl: 35, lvlreq: 20, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R2', { code: 'dmg/lvl', min: 10, max: 12 }, { lvl: 60, lvlreq: 40, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R1', { code: 'dmg/lvl', min: 12, max: 16 }, { lvl: 85, lvlreq: 60, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R4', { code: 'dmg/lvl', min: 3, max: 4 }, { lvl: 15, lvlreq: 10, freq: 1 }, M_ITS.CM3],
    ['R3', { code: 'dmg/lvl', min: 4, max: 5 }, { lvl: 35, lvlreq: 20, freq: 1 }, M_ITS.CM3],
    ['R2', { code: 'dmg/lvl', min: 5, max: 6 }, { lvl: 60, lvlreq: 40, freq: 1 }, M_ITS.CM3],
    ['R1', { code: 'dmg/lvl', min: 6, max: 8 }, { lvl: 85, lvlreq: 60, freq: 1 }, M_ITS.CM3],
    ['R4', { code: 'dmg/lvl', min: 3, max: 4 }, { lvl: 15, lvlreq: 9, freq: 1 }, M_ITS.JEW],
    ['R3', { code: 'dmg/lvl', min: 4, max: 5 }, { lvl: 35, lvlreq: 20, freq: 1 }, M_ITS.JEW],
    ['R2', { code: 'dmg/lvl', min: 5, max: 6 }, { lvl: 60, lvlreq: 40, freq: 1 }, M_ITS.JEW],
    ['R1', { code: 'dmg/lvl', min: 6, max: 8 }, { lvl: 85, lvlreq: 60, freq: 1 }, M_ITS.JEW],
  ],
  'dmg-undead': [
    ['R1', { code: 'dmg-undead', min: 350, max: 450 }, { lvl: 85, lvlreq: 60, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R2', { code: 'dmg-undead', min: 250, max: 350 }, { lvl: 60, lvlreq: 40, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R3', { code: 'dmg-undead', min: 150, max: 250 }, { lvl: 35, lvlreq: 20, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R4', { code: 'dmg-undead', min: 100, max: 150 }, { lvl: 15, lvlreq: 10, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R1', { code: 'dmg-undead', min: 100, max: 150 }, { lvl: 75, lvlreq: 60, freq: 1 }, M_ITS.CM3],
    ['R2', { code: 'dmg-undead', min: 80, max: 100 }, { lvl: 55, lvlreq: 40, freq: 1 }, M_ITS.CM32],
    ['R3', { code: 'dmg-undead', min: 60, max: 80 }, { lvl: 35, lvlreq: 20, freq: 1 }, M_ITS.CM321],
    ['R4', { code: 'dmg-undead', min: 40, max: 60 }, { lvl: 15, lvlreq: 10, freq: 1 }, M_ITS.CM321],
    ['R1', { code: 'dmg-undead', min: 100, max: 120 }, { lvl: 60, lvlreq: 45, freq: 1 }, M_ITS.JEW],
    ['R2', { code: 'dmg-undead', min: 80, max: 100 }, { lvl: 40, lvlreq: 25, freq: 1 }, M_ITS.JEW],
    ['R1', { code: 'dmg-undead', min: 60, max: 80 }, { lvl: 20, lvlreq: 12, freq: 1 }, M_ITS.JEW],
  ],
  'dmg-demon': [
    ['R1', { code: 'dmg-demon', min: 300, max: 400 }, { lvl: 85, lvlreq: 60, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R2', { code: 'dmg-demon', min: 200, max: 300 }, { lvl: 60, lvlreq: 40, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R3', { code: 'dmg-demon', min: 150, max: 200 }, { lvl: 35, lvlreq: 20, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R4', { code: 'dmg-demon', min: 100, max: 150 }, { lvl: 15, lvlreq: 10, freq: 2 }, M_ITS.MELE_MISS, M_ETS.MAGIC_STAFF],
    ['R1', { code: 'dmg-demon', min: 100, max: 120 }, { lvl: 75, lvlreq: 60, freq: 1 }, M_ITS.CM3],
    ['R2', { code: 'dmg-demon', min: 80, max: 100 }, { lvl: 55, lvlreq: 40, freq: 1 }, M_ITS.CM32],
    ['R3', { code: 'dmg-demon', min: 60, max: 80 }, { lvl: 35, lvlreq: 20, freq: 1 }, M_ITS.CM321],
    ['R4', { code: 'dmg-demon', min: 50, max: 60 }, { lvl: 15, lvlreq: 10, freq: 1 }, M_ITS.CM321],
    ['R1', { code: 'dmg-demon', min: 80, max: 100 }, { lvl: 60, lvlreq: 45, freq: 1 }, M_ITS.JEW],
    ['R2', { code: 'dmg-demon', min: 60, max: 80 }, { lvl: 40, lvlreq: 25, freq: 1 }, M_ITS.JEW],
    ['R1', { code: 'dmg-demon', min: 50, max: 60 }, { lvl: 20, lvlreq: 12, freq: 1 }, M_ITS.JEW],
  ],
  ...
  // ['att%/lvl', MOD_TYPE.SUFFIX, '准确率%/等级'],
  'att': [
    ['R4', { code: 'att', min: 30, max: 40 }, { lvl: 15, lvlreq: 8, freq: 1 }, M_ITS.CM321_JEW],
    ['R3', { code: 'att', min: 50, max: 80 }, { lvl: 35, lvlreq: 15, freq: 1 }, M_ITS.CM32_JEW],
    ['R2', { code: 'att', min: 80, max: 100 }, { lvl: 60, lvlreq: 45, freq: 1 }, M_ITS.CM32_JEW],
  ...
  'att%': [
    ...
    ['R1', { code: 'att%', min: 70, max: 80 }, { lvl: 75, lvlreq: 65, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R4', { code: 'att%', min: 20, max: 30 }, { lvl: 15, lvlreq: 8, freq: 1 }, M_ITS.CM321_JEW],
    ['R3', { code: 'att%', min: 30, max: 50 }, { lvl: 35, lvlreq: 15, freq: 1 }, M_ITS.CM32_JEW],
    ['R2', { code: 'att%', min: 50, max: 70 }, { lvl: 60, lvlreq: 45, freq: 1 }, M_ITS.CM32_JEW],
  ...
  'att-demon': [
    ...
    ['R4', { code: 'att-demon', min: 50, max: 60 }, { lvl: 15, lvlreq: 8, freq: 1 }, M_ITS.CM321_JEW],
    ['R3', { code: 'att-demon', min: 60, max: 90 }, { lvl: 35, lvlreq: 15, freq: 1 }, M_ITS.CM32_JEW],
    ['R2', { code: 'att-demon', min: 90, max: 135 }, { lvl: 60, lvlreq: 45, freq: 1 }, M_ITS.CM32_JEW],
  ...
  'att-undead': [
    ...
    ['R4', { code: 'att-undead', min: 50, max: 80 }, { lvl: 15, lvlreq: 8, freq: 1 }, M_ITS.CM321_JEW],
    ['R3', { code: 'att-undead', min: 80, max: 120 }, { lvl: 35, lvlreq: 15, freq: 1 }, M_ITS.CM32_JEW],
    ['R2', { code: 'att-undead', min: 120, max: 160 }, { lvl: 60, lvlreq: 45, freq: 1 }, M_ITS.CM32_JEW],
  ...
  'dmg-fire': [
    ['R5', { code: 'dmg-fire', min: 10, max: 30 }, { lvl: 15, lvlreq: 8, freq: 1 }, M_ITS.CM321_JEW],
    ['R4', { code: 'dmg-fire', min: 30, max: 60 }, { lvl: 30, lvlreq: 15, freq: 1 }, M_ITS.CM321_JEW],
    ['R3', { code: 'dmg-fire', min: 60, max: 90 }, { lvl: 50, lvlreq: 35, freq: 1 }, M_ITS.CM32_JEW],
    ['R2', { code: 'dmg-fire', min: 90, max: 120 }, { lvl: 70, lvlreq: 45, freq: 1 }, M_ITS.CM3_JEW],
    ['R1', { code: 'dmg-fire', min: 120, max: 150 }, { lvl: 80, lvlreq: 65, freq: 1 }, M_ITS.CM3],
    ['R5', { code: 'dmg-fire', min: 30, max: 60 }, { lvl: 15, lvlreq: 10, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R4', { code: 'dmg-fire', min: 60, max: 100 }, { lvl: 30, lvlreq: 15, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R3', { code: 'dmg-fire', min: 100, max: 150 }, { lvl: 50, lvlreq: 35, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R2', { code: 'dmg-fire', min: 150, max: 250 }, { lvl: 70, lvlreq: 45, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R1', { code: 'dmg-fire', min: 250, max: 350 }, { lvl: 80, lvlreq: 65, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
  ],
  'dmg-ltng': [
    ['R5', { code: 'dmg-ltng', min: 10, max: 30 }, { lvl: 15, lvlreq: 8, freq: 1 }, M_ITS.CM321_JEW],
    ['R4', { code: 'dmg-ltng', min: 30, max: 60 }, { lvl: 30, lvlreq: 15, freq: 1 }, M_ITS.CM321_JEW],
    ['R3', { code: 'dmg-ltng', min: 60, max: 90 }, { lvl: 50, lvlreq: 35, freq: 1 }, M_ITS.CM32_JEW],
    ['R2', { code: 'dmg-ltng', min: 90, max: 120 }, { lvl: 70, lvlreq: 45, freq: 1 }, M_ITS.CM3_JEW],
    ['R1', { code: 'dmg-ltng', min: 120, max: 150 }, { lvl: 80, lvlreq: 65, freq: 1 }, M_ITS.CM3],
    ['R5', { code: 'dmg-ltng', min: 30, max: 60 }, { lvl: 15, lvlreq: 10, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R4', { code: 'dmg-ltng', min: 60, max: 100 }, { lvl: 30, lvlreq: 15, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R3', { code: 'dmg-ltng', min: 100, max: 150 }, { lvl: 50, lvlreq: 35, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R2', { code: 'dmg-ltng', min: 150, max: 250 }, { lvl: 70, lvlreq: 45, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R1', { code: 'dmg-ltng', min: 250, max: 350 }, { lvl: 80, lvlreq: 65, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
  ],
  'dmg-cold': [
    ['R5', { code: 'dmg-cold', param: 50, min: 10, max: 30 }, { lvl: 15, lvlreq: 8, freq: 1 }, M_ITS.CM321_JEW],
    ['R4', { code: 'dmg-cold', param: 50, min: 30, max: 60 }, { lvl: 30, lvlreq: 15, freq: 1 }, M_ITS.CM321_JEW],
    ['R3', { code: 'dmg-cold', param: 50, min: 60, max: 90 }, { lvl: 50, lvlreq: 35, freq: 1 }, M_ITS.CM32_JEW],
    ['R2', { code: 'dmg-cold', param: 50, min: 90, max: 120 }, { lvl: 70, lvlreq: 42, freq: 1 }, M_ITS.CM3_JEW],
    ['R1', { code: 'dmg-cold', param: 50, min: 120, max: 150 }, { lvl: 80, lvlreq: 65, freq: 1 }, M_ITS.CM3],
    ['R5', { code: 'dmg-cold', param: 50, min: 30, max: 60 }, { lvl: 15, lvlreq: 10, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R4', { code: 'dmg-cold', param: 50, min: 60, max: 100 }, { lvl: 30, lvlreq: 15, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R3', { code: 'dmg-cold', param: 50, min: 100, max: 150 }, { lvl: 50, lvlreq: 35, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R2', { code: 'dmg-cold', param: 50, min: 150, max: 250 }, { lvl: 70, lvlreq: 43, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R1', { code: 'dmg-cold', param: 50, min: 250, max: 350 }, { lvl: 80, lvlreq: 65, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
  ],
  'dmg-pois': [
    ['R5', { code: 'dmg-pois', param: 75, min: 50, max: 100 }, { lvl: 15, lvlreq: 8, freq: 1 }, M_ITS.CM321_JEW],
    ['R4', { code: 'dmg-pois', param: 75, min: 100, max: 150 }, { lvl: 30, lvlreq: 15, freq: 1 }, M_ITS.CM321_JEW],
    ['R3', { code: 'dmg-pois', param: 75, min: 150, max: 250 }, { lvl: 50, lvlreq: 35, freq: 1 }, M_ITS.CM32_JEW],
    ['R2', { code: 'dmg-pois', param: 75, min: 250, max: 350 }, { lvl: 70, lvlreq: 45, freq: 1 }, M_ITS.CM3_JEW],
    ['R1', { code: 'dmg-pois', param: 75, min: 350, max: 450 }, { lvl: 80, lvlreq: 65, freq: 1 }, M_ITS.CM3],
    ['R5', { code: 'dmg-pois', param: 75, min: 50, max: 100 }, { lvl: 15, lvlreq: 10, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R4', { code: 'dmg-pois', param: 75, min: 100, max: 150 }, { lvl: 30, lvlreq: 15, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R3', { code: 'dmg-pois', param: 75, min: 150, max: 250 }, { lvl: 50, lvlreq: 35, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R2', { code: 'dmg-pois', param: 75, min: 250, max: 350 }, { lvl: 70, lvlreq: 45, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R1', { code: 'dmg-pois', param: 75, min: 350, max: 450 }, { lvl: 80, lvlreq: 65, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
  ],
  'dmg-mag': [
    ['R5', { code: 'dmg-mag', min: 10, max: 30 }, { lvl: 15, lvlreq: 8, freq: 1 }, M_ITS.CM321_JEW],
    ['R4', { code: 'dmg-mag', min: 30, max: 60 }, { lvl: 30, lvlreq: 15, freq: 1 }, M_ITS.CM321_JEW],
    ['R3', { code: 'dmg-mag', min: 60, max: 90 }, { lvl: 50, lvlreq: 35, freq: 1 }, M_ITS.CM32_JEW],
    ['R2', { code: 'dmg-mag', min: 90, max: 120 }, { lvl: 70, lvlreq: 45, freq: 1 }, M_ITS.CM3_JEW],
    ['R1', { code: 'dmg-mag', min: 120, max: 150 }, { lvl: 80, lvlreq: 65, freq: 1 }, M_ITS.CM3],
    ['R5', { code: 'dmg-mag', min: 30, max: 60 }, { lvl: 15, lvlreq: 10, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R4', { code: 'dmg-mag', min: 60, max: 100 }, { lvl: 30, lvlreq: 15, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R3', { code: 'dmg-mag', min: 100, max: 150 }, { lvl: 50, lvlreq: 35, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R2', { code: 'dmg-mag', min: 150, max: 250 }, { lvl: 70, lvlreq: 45, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
    ['R1', { code: 'dmg-mag', min: 250, max: 350 }, { lvl: 80, lvlreq: 65, freq: 1 }, M_ITS.NORMAL, M_ETS.MAGIC_STAFF],
  ],
  ...
  'extra-fire': [
    ['R4', { code: 'extra-fire', min: 3, max: 5 }, { lvl: 30, lvlreq: 15, freq: 2 }, M_ITS.CASTER_LOW],
    ['R3', { code: 'extra-fire', min: 5, max: 8 }, { lvl: 70, lvlreq: 35, freq: 2 }, M_ITS.CASTER_LOW],
    ['R2', { code: 'extra-fire', min: 5, max: 8 }, { lvl: 75, lvlreq: 55, freq: 2 }, M_ITS.CASTER_UPP],
    ['R1', { code: 'extra-fire', min: 6, max: 10 }, { lvl: 85, lvlreq: 62, freq: 2 }, M_ITS.CASTER_UPP],
  ],
  'extra-cold': [
    ['R4', { code: 'extra-cold', min: 3, max: 5 }, { lvl: 30, lvlreq: 15, freq: 2 }, M_ITS.CASTER_LOW],
    ['R3', { code: 'extra-cold', min: 5, max: 8 }, { lvl: 50, lvlreq: 35, freq: 2 }, M_ITS.CASTER_LOW],
    ['R2', { code: 'extra-cold', min: 5, max: 8 }, { lvl: 75, lvlreq: 55, freq: 2 }, M_ITS.CASTER_UPP],
    ['R1', { code: 'extra-cold', min: 6, max: 10 }, { lvl: 85, lvlreq: 63, freq: 2 }, M_ITS.CASTER_UPP],
  ],
  'extra-ltng': [
    ['R4', { code: 'extra-ltng', min: 3, max: 5 }, { lvl: 30, lvlreq: 15, freq: 2 }, M_ITS.CASTER_LOW],
    ['R3', { code: 'extra-ltng', min: 5, max: 8 }, { lvl: 50, lvlreq: 35, freq: 2 }, M_ITS.CASTER_LOW],
    ['R2', { code: 'extra-ltng', min: 5, max: 8 }, { lvl: 75, lvlreq: 55, freq: 2 }, M_ITS.CASTER_UPP],
    ['R1', { code: 'extra-ltng', min: 6, max: 10 }, { lvl: 85, lvlreq: 64, freq: 2 }, M_ITS.CASTER_UPP],
  ],
  'extra-pois': [
    ['R4', { code: 'extra-pois', min: 3, max: 5 }, { lvl: 30, lvlreq: 15, freq: 2 }, M_ITS.CASTER_LOW],
    ['R3', { code: 'extra-pois', min: 5, max: 8 }, { lvl: 50, lvlreq: 35, freq: 2 }, M_ITS.CASTER_LOW],
    ['R2', { code: 'extra-pois', min: 5, max: 8 }, { lvl: 75, lvlreq: 55, freq: 2 }, M_ITS.CASTER_UPP],
    ['R1', { code: 'extra-pois', min: 6, max: 10 }, { lvl: 85, lvlreq: 61, freq: 2 }, M_ITS.CASTER_UPP],
  ],
  'pierce-fire': [
    ['R4', { code: 'pierce-fire', min: 3, max: 5 }, { lvl: 30, lvlreq: 15, freq: 2 }, M_ITS.CASTER_LOW],
    ['R3', { code: 'pierce-fire', min: 5, max: 8 }, { lvl: 50, lvlreq: 35, freq: 2 }, M_ITS.CASTER_LOW],
  ...
  'pierce-cold': [
    ['R4', { code: 'pierce-cold', min: 3, max: 5 }, { lvl: 30, lvlreq: 15, freq: 2 }, M_ITS.CASTER_LOW],
    ['R3', { code: 'pierce-cold', min: 5, max: 8 }, { lvl: 50, lvlreq: 35, freq: 2 }, M_ITS.CASTER_LOW],
  ...
  'pierce-ltng': [
    ['R4', { code: 'pierce-ltng', min: 3, max: 5 }, { lvl: 30, lvlreq: 15, freq: 2 }, M_ITS.CASTER_LOW],
    ['R3', { code: 'pierce-ltng', min: 5, max: 8 }, { lvl: 50, lvlreq: 35, freq: 2 }, M_ITS.CASTER_LOW],
  ...
  'pierce-pois': [
    ['R4', { code: 'pierce-pois', min: 3, max: 5 }, { lvl: 30, lvlreq: 15, freq: 2 }, M_ITS.CASTER_LOW],
    ['R3', { code: 'pierce-pois', min: 5, max: 8 }, { lvl: 50, lvlreq: 35, freq: 2 }, M_ITS.CASTER_LOW],
  ...
  'cast2': [
    ['R1-1', { code: 'cast2', min: 20, max: 30 }, { lvl: 75, lvlreq: 45, freq: 3 }, M_ITS.CASTER_UPP],
    ...
    ['R3-1', { code: 'cast2', min: 10, max: 15 }, { lvl: 50, lvlreq: 15, freq: 3 }, M_ITS.CM3_JEW],
    ['R3-2', { code: 'cast2', min: 10, max: 15 }, { lvl: 30, lvlreq: 15, freq: 3 }, M_ITS.CM3_JEW],
    ['R3-3', { code: 'cast2', min: 10, max: 10 }, { lvl: 10, lvlreq: 15, freq: 3 }, M_ITS.CM3_JEW],
  ],
  'swing2': [
    ['R1', { code: 'swing2', min: 20, max: 30 }, { lvl: 75, lvlreq: 45, freq: 3 }, M_ITS.MELE_MISS],
    ['R2', { code: 'swing2', min: 15, max: 20 }, { lvl: 55, lvlreq: 25, freq: 3 }, M_ITS.MELE_MISS.concat(M_ITS.JEW)],
    ['R3', { code: 'swing2', min: 10, max: 15 }, { lvl: 20, lvlreq: 15, freq: 3 }, M_ITS.MELE_MISS.concat(M_ITS.CM3_JEW)],
  ],
  'move2': [
    ['R1', { code: 'move2', min: 25, max: 40 }, { lvl: 65, lvlreq: 45, freq: 3 }, [`shld`, `belt`, `boot`]],
    ['R2', { code: 'move2', min: 15, max: 30 }, { lvl: 50, lvlreq: 25, freq: 3 }, [`shld`, `belt`, `boot`].concat(M_ITS.CM3_JEW)],
    ['R3', { code: 'move2', min: 10, max: 20 }, { lvl: 40, lvlreq: 15, freq: 3 }, M_ITS.CM32_JEW],
  ],
  'balance2': [
    ['R1', { code: 'balance2', min: 25, max: 40 }, { lvl: 65, lvlreq: 45, freq: 3 }, M_ITS.NORMAL],
    ['R2', { code: 'balance2', min: 15, max: 30 }, { lvl: 50, lvlreq: 25, freq: 3 }, M_ITS.NORMAL.concat(M_ITS.CM3_JEW)],
    ['R3', { code: 'balance2', min: 10, max: 20 }, { lvl: 40, lvlreq: 15, freq: 3 }, M_ITS.JEW.concat(M_ITS.CM32)],
  ],
  ...
  'hp-mana%': [
    ['R4', { code: 'mana%', min: 2, max: 3, code2: 'hp%', min: 2, max: 3 }, { lvl: 14, lvlreq: 9, freq: 2 }, M_ITS.CM3_JEW],
    ['R3', { code: 'mana%', min: 3, max: 4, code2: 'hp%', min2: 3, max2: 4 }, { lvl: 25, lvlreq: 15, freq: 2 }, M_ITS.CM3_JEW],
    ['R2', { code: 'mana%', min: 4, max: 5, code2: 'hp%', min2: 4, max2: 5 }, { lvl: 45, lvlreq: 35, freq: 2 }, M_ITS.CM3_JEW],
    ['R1', { code: 'mana%', min: 5, max: 6, code2: 'hp%', min2: 5, max2: 6 }, { lvl: 65, lvlreq: 50, freq: 2 }, M_ITS.CM3_JEW],
    ['R5', { code: 'mana%', min: 2, max: 4, code2: 'hp%', min2: 2, max2: 4 }, { lvl: 15, lvlreq: 10, freq: 2 }, M_ITS.NORMAL],
    ['R4', { code: 'mana%', min: 3, max: 5, code2: 'hp%', min2: 3, max2: 5 }, { lvl: 25, lvlreq: 20, freq: 2 }, M_ITS.NORMAL],
    ['R3', { code: 'mana%', min: 4, max: 6, code2: 'hp%', min2: 4, max2: 6 }, { lvl: 45, lvlreq: 30, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'mana%', min: 5, max: 8, code2: 'hp%', min2: 5, max2: 8 }, { lvl: 65, lvlreq: 50, freq: 2 }, M_ITS.NORMAL],
    ['R1', { code: 'mana%', min: 6, max: 10, code2: 'hp%', min2: 6, max2: 10 }, { lvl: 75, lvlreq: 60, freq: 2 }, M_ITS.NORMAL],
  ],
  'super-hp': [
    ['R1', { code: 'hp', min: 60, max: 80 }, { lvl: 75, lvlreq: 60, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'hp', min: 50, max: 60 }, { lvl: 65, lvlreq: 40, freq: 2 }, M_ITS.NORMAL],
    ['R3', { code: 'hp', min: 40, max: 50 }, { lvl: 50, lvlreq: 25, freq: 2 }, M_ITS.NORMAL],
    ['R4', { code: 'hp', min: 30, max: 40 }, { lvl: 35, lvlreq: 15, freq: 2 }, M_ITS.NORMAL],
    ['R5', { code: 'hp', min: 15, max: 30 }, { lvl: 20, lvlreq: 10, freq: 2 }, M_ITS.NORMAL],
    ['R6', { code: 'hp', min: 10, max: 20 }, { lvl: 10, lvlreq: 5, freq: 2 }, M_ITS.NORMAL],
    ['R1', { code: 'hp', min: 40, max: 60 }, { lvl: 65, lvlreq: 40, freq: 2 }, M_ITS.CM3_JEW],
    ['R2', { code: 'hp', min: 30, max: 50 }, { lvl: 50, lvlreq: 25, freq: 2 }, M_ITS.CM32_JEW],
    ['R3', { code: 'hp', min: 20, max: 40 }, { lvl: 35, lvlreq: 15, freq: 2 }, M_ITS.CM32_JEW],
    ['R4', { code: 'hp', min: 15, max: 30 }, { lvl: 20, lvlreq: 10, freq: 2 }, M_ITS.CM321_JEW],
    ['R5', { code: 'hp', min: 10, max: 20 }, { lvl: 10, lvlreq: 5, freq: 2 }, M_ITS.CM321],
  ],
  'super-mana': [
    ['R1', { code: 'mana', min: 60, max: 100 }, { lvl: 75, lvlreq: 60, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'mana', min: 50, max: 80 }, { lvl: 65, lvlreq: 40, freq: 2 }, M_ITS.NORMAL],
    ['R3', { code: 'mana', min: 40, max: 60 }, { lvl: 50, lvlreq: 25, freq: 2 }, M_ITS.NORMAL],
    ['R4', { code: 'mana', min: 30, max: 50 }, { lvl: 35, lvlreq: 15, freq: 2 }, M_ITS.NORMAL],
    ['R5', { code: 'mana', min: 20, max: 40 }, { lvl: 20, lvlreq: 10, freq: 2 }, M_ITS.NORMAL],
    ['R6', { code: 'mana', min: 15, max: 30 }, { lvl: 10, lvlreq: 5, freq: 2 }, M_ITS.NORMAL],
    ['R1', { code: 'mana', min: 60, max: 80 }, { lvl: 65, lvlreq: 40, freq: 2 }, M_ITS.CM3_JEW],
    ['R2', { code: 'mana', min: 40, max: 60 }, { lvl: 50, lvlreq: 25, freq: 2 }, M_ITS.CM32_JEW],
    ['R3', { code: 'mana', min: 30, max: 50 }, { lvl: 35, lvlreq: 15, freq: 2 }, M_ITS.CM32_JEW],
    ['R4', { code: 'mana', min: 20, max: 40 }, { lvl: 20, lvlreq: 10, freq: 2 }, M_ITS.CM321_JEW],
    ['R5', { code: 'mana', min: 15, max: 25 }, { lvl: 10, lvlreq: 5, freq: 2 }, M_ITS.CM321],
  ],
  'super-hp%': [
    ['R1', { code: 'hp%', min: 8, max: 12 }, { lvl: 75, lvlreq: 55, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'hp%', min: 6, max: 10 }, { lvl: 50, lvlreq: 25, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM3_JEW)],
    ['R3', { code: 'hp%', min: 5, max: 8 }, { lvl: 35, lvlreq: 15, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM3_JEW)],
    ['R4', { code: 'hp%', min: 4, max: 6 }, { lvl: 20, lvlreq: 10, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM32_JEW)],
    ['R5', { code: 'hp%', min: 2, max: 4 }, { lvl: 13, lvlreq: 5, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM32_JEW)],
  ],
  'super-mana%': [
    ['R1', { code: 'mana%', min: 10, max: 15 }, { lvl: 75, lvlreq: 55, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'mana%', min: 8, max: 12 }, { lvl: 50, lvlreq: 25, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM3_JEW)],
    ['R3', { code: 'mana%', min: 6, max: 10 }, { lvl: 35, lvlreq: 15, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM3_JEW)],
    ['R4', { code: 'mana%', min: 5, max: 8 }, { lvl: 20, lvlreq: 10, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM32_JEW)],
    ['R5', { code: 'mana%', min: 4, max: 6 }, { lvl: 13, lvlreq: 5, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM32_JEW)],
  ],
  'lvl-hp': [
    ['R1', { code: 'hp/lvl', min: 12, max: 14 }, { lvl: 75, lvlreq: 55, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'hp/lvl', min: 10, max: 12 }, { lvl: 50, lvlreq: 25, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM3_JEW)],
    ['R3', { code: 'hp/lvl', min: 6, max: 10 }, { lvl: 35, lvlreq: 15, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM32_JEW)],
    ['R4', { code: 'hp/lvl', min: 6, max: 8 }, { lvl: 20, lvlreq: 10, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM32_JEW)],
    ['R5', { code: 'hp/lvl', min: 4, max: 6 }, { lvl: 13, lvlreq: 5, freq: 2 }, M_ITS.CM32_JEW],
  ],
  'lvl-mana': [
    ['R1', { code: 'mana/lvl', min: 12, max: 16 }, { lvl: 75, lvlreq: 55, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'mana/lvl', min: 10, max: 12 }, { lvl: 50, lvlreq: 25, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM3_JEW)],
    ['R3', { code: 'mana/lvl', min: 8, max: 10 }, { lvl: 35, lvlreq: 15, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM32_JEW)],
    ['R4', { code: 'mana/lvl', min: 6, max: 8 }, { lvl: 20, lvlreq: 10, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM32_JEW)],
    ['R5', { code: 'mana/lvl', min: 4, max: 6 }, { lvl: 15, lvlreq: 5, freq: 2 }, M_ITS.CM32_JEW],
  ],
  ...
  'all-stats': [
    ...
    ['R3', { code: 'all-stats', min: 6, max: 10 }, { lvl: 45, lvlreq: 25, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM32_JEW)],
    ['R4', { code: 'all-stats', min: 5, max: 8 }, { lvl: 30, lvlreq: 15, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM32_JEW)],
    ['R5', { code: 'all-stats', min: 3, max: 5 }, { lvl: 15, lvlreq: 10, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM321_JEW)],
  ],
  'super-str': [
    ...
    ['R3', { code: 'str', min: 12, max: 16 }, { lvl: 40, lvlreq: 25, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM3_JEW)],
    ['R4', { code: 'str', min: 8, max: 12 }, { lvl: 25, lvlreq: 10, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM32_JEW)],
    ['R5', { code: 'str', min: 4, max: 8 }, { lvl: 10, lvlreq: 5, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM321_JEW)],
  ],
  'super-vit': [
    ...
    ['R3', { code: 'vit', min: 12, max: 16 }, { lvl: 40, lvlreq: 25, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM3_JEW)],
    ['R4', { code: 'vit', min: 8, max: 12 }, { lvl: 25, lvlreq: 10, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM32_JEW)],
    ['R5', { code: 'vit', min: 4, max: 8 }, { lvl: 10, lvlreq: 5, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM321_JEW)],
  ],
  'super-dex': [
    ...
    ['R3', { code: 'dex', min: 12, max: 16 }, { lvl: 40, lvlreq: 25, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM3_JEW)],
    ['R4', { code: 'dex', min: 8, max: 12 }, { lvl: 25, lvlreq: 10, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM32_JEW)],
    ['R5', { code: 'dex', min: 4, max: 8 }, { lvl: 10, lvlreq: 5, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM321_JEW)],
  ],
  'super-enr': [
    ...
    ['R3', { code: 'enr', min: 12, max: 16 }, { lvl: 40, lvlreq: 25, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM3_JEW)],
    ['R4', { code: 'enr', min: 8, max: 12 }, { lvl: 25, lvlreq: 10, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM32_JEW)],
    ['R5', { code: 'enr', min: 4, max: 8 }, { lvl: 10, lvlreq: 5, freq: 2 }, M_ITS.NORMAL.concat(M_ITS.CM321_JEW)],
  ],
  ...
  'res-all': [
    ['R5', { code: 'res-all', min: 3, max: 6 }, { lvl: 12, lvlreq: 7, freq: 2 }, M_ITS.CM321],
    ['R4', { code: 'res-all', min: 6, max: 9 }, { lvl: 30, lvlreq: 15, freq: 2 }, M_ITS.CM32_JEW],
    ...
    ['R1', { code: 'res-all', min: 15, max: 18 }, { lvl: 75, lvlreq: 55, freq: 2 }, M_ITS.CM3],
    ['R5', { code: 'res-all', min: 8, max: 10 }, { lvl: 15, lvlreq: 7, freq: 2 }, M_ITS.NORMAL],
    ['R4', { code: 'res-all', min: 10, max: 12 }, { lvl: 30, lvlreq: 15, freq: 2 }, M_ITS.NORMAL],
    ...
    ['R1', { code: 'res-all', min: 20, max: 24 }, { lvl: 75, lvlreq: 55, freq: 2 }, M_ITS.NORMAL],
  ],
  'res-fire': [
    ['R1', { code: 'res-fire', min: 30, max: 48 }, { lvl: 75, lvlreq: 55, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'res-fire', min: 20, max: 40 }, { lvl: 55, lvlreq: 35, freq: 2 }, M_ITS.NORMAL],
    ['R3', { code: 'res-fire', min: 16, max: 30 }, { lvl: 35, lvlreq: 25, freq: 2 }, M_ITS.NORMAL],
    ['R4', { code: 'res-fire', min: 12, max: 20 }, { lvl: 15, lvlreq: 7, freq: 2 }, M_ITS.NORMAL],
    ['R1', { code: 'res-fire', min: 20, max: 36 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.CM3],
    ['R2', { code: 'res-fire', min: 20, max: 30 }, { lvl: 55, lvlreq: 30, freq: 2 }, M_ITS.CM3_JEW],
    ['R3', { code: 'res-fire', min: 16, max: 24 }, { lvl: 35, lvlreq: 15, freq: 2 }, M_ITS.CM32_JEW],
    ['R4', { code: 'res-fire', min: 6, max: 12 }, { lvl: 12, lvlreq: 7, freq: 2 }, M_ITS.CM321],
  ],
  'res-cold': [
    ['R1', { code: 'res-cold', min: 30, max: 48 }, { lvl: 75, lvlreq: 55, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'res-cold', min: 20, max: 40 }, { lvl: 55, lvlreq: 35, freq: 2 }, M_ITS.NORMAL],
    ['R3', { code: 'res-cold', min: 16, max: 30 }, { lvl: 35, lvlreq: 25, freq: 2 }, M_ITS.NORMAL],
    ['R4', { code: 'res-cold', min: 12, max: 20 }, { lvl: 15, lvlreq: 7, freq: 2 }, M_ITS.NORMAL],
    ['R1', { code: 'res-cold', min: 20, max: 36 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.CM3],
    ['R2', { code: 'res-cold', min: 20, max: 30 }, { lvl: 55, lvlreq: 30, freq: 2 }, M_ITS.CM3_JEW],
    ['R3', { code: 'res-cold', min: 16, max: 24 }, { lvl: 35, lvlreq: 15, freq: 2 }, M_ITS.CM32_JEW],
    ['R4', { code: 'res-cold', min: 6, max: 12 }, { lvl: 12, lvlreq: 7, freq: 2 }, M_ITS.CM321],
  ],
  'res-ltng': [
    ['R4', { code: 'res-ltng', min: 6, max: 12 }, { lvl: 12, lvlreq: 7, freq: 2 }, M_ITS.CM321],
    ['R3', { code: 'res-ltng', min: 16, max: 24 }, { lvl: 35, lvlreq: 15, freq: 2 }, M_ITS.CM32_JEW],
    ['R2', { code: 'res-ltng', min: 20, max: 30 }, { lvl: 55, lvlreq: 30, freq: 2 }, M_ITS.CM3_JEW],
    ['R1', { code: 'res-ltng', min: 20, max: 36 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.CM3],
    ['R4', { code: 'res-ltng', min: 12, max: 20 }, { lvl: 15, lvlreq: 7, freq: 2 }, M_ITS.NORMAL],
    ['R3', { code: 'res-ltng', min: 16, max: 30 }, { lvl: 35, lvlreq: 25, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'res-ltng', min: 20, max: 40 }, { lvl: 55, lvlreq: 35, freq: 2 }, M_ITS.NORMAL],
  ...
  'res-pois': [
    ...
    ['R2', { code: 'res-pois', min: 20, max: 40 }, { lvl: 55, lvlreq: 35, freq: 2 }, M_ITS.NORMAL],
    ['R3', { code: 'res-pois', min: 16, max: 30 }, { lvl: 35, lvlreq: 25, freq: 2 }, M_ITS.NORMAL],
    ['R4', { code: 'res-pois', min: 12, max: 20 }, { lvl: 15, lvlreq: 7, freq: 2 }, M_ITS.NORMAL],
    ['R1', { code: 'res-pois', min: 20, max: 36 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.CM3],
    ['R2', { code: 'res-pois', min: 20, max: 30 }, { lvl: 55, lvlreq: 30, freq: 2 }, M_ITS.CM3_JEW],
    ['R3', { code: 'res-pois', min: 16, max: 24 }, { lvl: 35, lvlreq: 15, freq: 2 }, M_ITS.CM32_JEW],
    ['R4', { code: 'res-pois', min: 6, max: 12 }, { lvl: 12, lvlreq: 7, freq: 2 }, M_ITS.CM321],
  ],
  'dual-res': [
    ['R2-FC', { code: 'res-fire', min: 12, max: 20, code2: 'res-cold', min2: 12, max2: 20 }, { lvl: 45, lvlreq: 25, freq: 2 }, M_ITS.ARMO],
    ['R2-FL', { code: 'res-fire', min: 12, max: 20, code2: 'res-ltng', min2: 12, max2: 20 }, { lvl: 45, lvlreq: 25, freq: 2 }, M_ITS.ARMO],
    ['R2-FP', { code: 'res-fire', min: 12, max: 20, code2: 'res-pois', min2: 12, max2: 20 }, { lvl: 45, lvlreq: 25, freq: 2 }, M_ITS.ARMO],
    ['R2-CL', { code: 'res-cold', min: 12, max: 20, code2: 'res-ltng', min2: 12, max2: 20 }, { lvl: 45, lvlreq: 25, freq: 2 }, M_ITS.ARMO],
    ['R2-CP', { code: 'res-cold', min: 12, max: 20, code2: 'res-pois', min2: 12, max2: 20 }, { lvl: 45, lvlreq: 25, freq: 2 }, M_ITS.ARMO],
    ['R2-LP', { code: 'res-ltng', min: 12, max: 20, code2: 'res-pois', min2: 12, max2: 20 }, { lvl: 45, lvlreq: 25, freq: 2 }, M_ITS.ARMO],
  ...
  'res-all-max': [
    ['R4', { code: 'res-all-max', min: 2, max: 2 }, { lvl: 40, lvlreq: 15, freq: 1 }, M_ITS.CM32_JEW],
    ['R3', { code: 'res-all-max', min: 3, max: 3 }, { lvl: 40, lvlreq: 15, freq: 1 }, M_ITS.CM3_JEW],
    ['R2', { code: 'res-all-max', min: 4, max: 4 }, { lvl: 55, lvlreq: 25, freq: 1 }, M_ITS.NORMAL],
    ['R1', { code: 'res-all-max', min: 5, max: 5 }, { lvl: 75, lvlreq: 45, freq: 1 }, M_ITS.NORMAL],
  ],
  'res-fire-max': [
    ['R1', { code: 'res-fire-max', min: 8, max: 10 }, { lvl: 75, lvlreq: 45, freq: 1 }, M_ITS.NORMAL],
    ['R2', { code: 'res-fire-max', min: 6, max: 8 }, { lvl: 55, lvlreq: 25, freq: 1 }, M_ITS.NORMAL],
    ['R3', { code: 'res-fire-max', min: 4, max: 6 }, { lvl: 40, lvlreq: 15, freq: 1 }, M_ITS.CM3_JEW],
    ['R4', { code: 'res-fire-max', min: 3, max: 4 }, { lvl: 40, lvlreq: 15, freq: 1 }, M_ITS.CM32_JEW],
  ],
  'res-cold-max': [
    ['R1', { code: 'res-cold-max', min: 8, max: 10 }, { lvl: 75, lvlreq: 45, freq: 1 }, M_ITS.NORMAL],
    ['R2', { code: 'res-cold-max', min: 6, max: 8 }, { lvl: 55, lvlreq: 25, freq: 1 }, M_ITS.NORMAL],
    ['R3', { code: 'res-cold-max', min: 4, max: 6 }, { lvl: 40, lvlreq: 15, freq: 1 }, M_ITS.CM3_JEW],
    ['R4', { code: 'res-cold-max', min: 3, max: 4 }, { lvl: 40, lvlreq: 15, freq: 1 }, M_ITS.CM32_JEW],
  ],
  'res-ltng-max': [
    ['R1', { code: 'res-ltng-max', min: 8, max: 10 }, { lvl: 75, lvlreq: 45, freq: 1 }, M_ITS.NORMAL],
    ['R2', { code: 'res-ltng-max', min: 6, max: 8 }, { lvl: 55, lvlreq: 25, freq: 1 }, M_ITS.NORMAL],
    ['R3', { code: 'res-ltng-max', min: 4, max: 6 }, { lvl: 40, lvlreq: 15, freq: 1 }, M_ITS.CM3_JEW],
    ['R4', { code: 'res-ltng-max', min: 3, max: 4 }, { lvl: 40, lvlreq: 15, freq: 1 }, M_ITS.CM32_JEW],
  ],
  'res-pois-max': [
    ['R1', { code: 'res-pois-max', min: 8, max: 10 }, { lvl: 75, lvlreq: 45, freq: 1 }, M_ITS.NORMAL],
    ['R2', { code: 'res-pois-max', min: 6, max: 8 }, { lvl: 55, lvlreq: 25, freq: 1 }, M_ITS.NORMAL],
    ['R3', { code: 'res-pois-max', min: 4, max: 6 }, { lvl: 40, lvlreq: 15, freq: 1 }, M_ITS.CM3_JEW],
    ['R4', { code: 'res-pois-max', min: 3, max: 4 }, { lvl: 40, lvlreq: 15, freq: 1 }, M_ITS.CM32_JEW],
  ],
  ...
  // // ['abs-pois%', MOD_TYPE.PREFIX, '毒素吸收%'],
  'abs-mag': [
    ['R1', { code: 'abs-mag', min: 8, max: 12 }, { lvl: 85, lvlreq: 45, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'abs-mag', min: 7, max: 10 }, { lvl: 55, lvlreq: 25, freq: 2 }, M_ITS.NORMAL],
    ['R3', { code: 'abs-mag', min: 6, max: 7 }, { lvl: 40, lvlreq: 15, freq: 2 }, M_ITS.CM3_JEW],
    ['R4', { code: 'abs-mag', min: 5, max: 6 }, { lvl: 40, lvlreq: 15, freq: 2 }, M_ITS.CM32_JEW],
  ],
  'abs-fire': [
    ['R1', { code: 'abs-fire', min: 8, max: 12 }, { lvl: 85, lvlreq: 45, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'abs-fire', min: 7, max: 10 }, { lvl: 55, lvlreq: 25, freq: 2 }, M_ITS.NORMAL],
    ['R3', { code: 'abs-fire', min: 6, max: 7 }, { lvl: 40, lvlreq: 15, freq: 2 }, M_ITS.CM3_JEW],
    ['R4', { code: 'abs-fire', min: 5, max: 6 }, { lvl: 40, lvlreq: 15, freq: 2 }, M_ITS.CM32_JEW],
  ],
  'abs-cold': [
    ['R1', { code: 'abs-cold', min: 8, max: 12 }, { lvl: 85, lvlreq: 45, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'abs-cold', min: 7, max: 10 }, { lvl: 55, lvlreq: 25, freq: 2 }, M_ITS.NORMAL],
    ['R3', { code: 'abs-cold', min: 6, max: 7 }, { lvl: 40, lvlreq: 15, freq: 2 }, M_ITS.CM3_JEW],
    ['R4', { code: 'abs-cold', min: 5, max: 6 }, { lvl: 40, lvlreq: 15, freq: 2 }, M_ITS.CM32_JEW],
  ],
  'abs-ltng': [
    ['R1', { code: 'abs-ltng', min: 8, max: 12 }, { lvl: 85, lvlreq: 45, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'abs-ltng', min: 7, max: 10 }, { lvl: 55, lvlreq: 25, freq: 2 }, M_ITS.NORMAL],
    ['R3', { code: 'abs-ltng', min: 6, max: 7 }, { lvl: 40, lvlreq: 15, freq: 2 }, M_ITS.CM3_JEW],
    ['R4', { code: 'abs-ltng', min: 5, max: 6 }, { lvl: 40, lvlreq: 15, freq: 2 }, M_ITS.CM32_JEW],
  ],
  // 'abs-pois': [
  //   ['R1', { code: 'abs-pois', min: 8, max: 12 }, { lvl: 85,  lvlreq: 45, freq: 2 }, MOD_ITYPES['NORMAL']],
  // ],
  'abs-mag%': [
    ['R1', { code: 'abs-mag%', min: 5, max: 8 }, { lvl: 85, lvlreq: 45, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'abs-mag%', min: 4, max: 6 }, { lvl: 55, lvlreq: 25, freq: 2 }, M_ITS.NORMAL],
    ['R3', { code: 'abs-mag%', min: 3, max: 4 }, { lvl: 40, lvlreq: 15, freq: 2 }, M_ITS.CM3_JEW],
    ['R4', { code: 'abs-mag%', min: 2, max: 3 }, { lvl: 40, lvlreq: 15, freq: 2 }, M_ITS.CM32_JEW],
  ],
  'abs-fire%': [
    ['R1', { code: 'abs-fire%', min: 5, max: 8 }, { lvl: 85, lvlreq: 45, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'abs-fire%', min: 4, max: 6 }, { lvl: 55, lvlreq: 25, freq: 2 }, M_ITS.NORMAL],
    ['R3', { code: 'abs-fire%', min: 3, max: 4 }, { lvl: 40, lvlreq: 15, freq: 2 }, M_ITS.CM3_JEW],
    ['R4', { code: 'abs-fire%', min: 2, max: 3 }, { lvl: 40, lvlreq: 15, freq: 2 }, M_ITS.CM32_JEW],
  ],
  'abs-cold%': [
    ['R1', { code: 'abs-cold%', min: 5, max: 8 }, { lvl: 85, lvlreq: 45, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'abs-cold%', min: 4, max: 6 }, { lvl: 55, lvlreq: 25, freq: 2 }, M_ITS.NORMAL],
    ['R3', { code: 'abs-cold%', min: 3, max: 4 }, { lvl: 40, lvlreq: 15, freq: 2 }, M_ITS.CM3_JEW],
    ['R4', { code: 'abs-cold%', min: 2, max: 3 }, { lvl: 40, lvlreq: 15, freq: 2 }, M_ITS.CM32_JEW],
  ],
  'abs-ltng%': [
    ['R1', { code: 'abs-ltng%', min: 5, max: 8 }, { lvl: 85, lvlreq: 45, freq: 2 }, M_ITS.NORMAL],
    ['R2', { code: 'abs-ltng%', min: 4, max: 6 }, { lvl: 55, lvlreq: 25, freq: 2 }, M_ITS.NORMAL],
    ['R3', { code: 'abs-ltng%', min: 3, max: 4 }, { lvl: 40, lvlreq: 15, freq: 2 }, M_ITS.CM3_JEW],
    ['R4', { code: 'abs-ltng%', min: 2, max: 3 }, { lvl: 40, lvlreq: 15, freq: 2 }, M_ITS.CM32_JEW],
  ],
  // 'abs-pois%': [
  ...
  'ac-miss': [
    ['R4', { code: 'ac-miss', min: 60, max: 80 }, { lvl: 15, lvlreq: 10, freq: 2 }, M_ITS.ARMO],
    ['R3', { code: 'ac-miss', min: 80, max: 120 }, { lvl: 35, lvlreq: 20, freq: 2 }, M_ITS.ARMO],
    ['R2', { code: 'ac-miss', min: 120, max: 160 }, { lvl: 55, lvlreq: 40, freq: 2 }, M_ITS.ARMO],
    ['R1', { code: 'ac-miss', min: 160, max: 200 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.ARMO],
    ['R4', { code: 'ac-miss', min: 30, max: 60 }, { lvl: 15, lvlreq: 10, freq: 2 }, M_ITS.CM321],
    ['R3', { code: 'ac-miss', min: 40, max: 90 }, { lvl: 35, lvlreq: 20, freq: 2 }, M_ITS.CM32],
    ['R2', { code: 'ac-miss', min: 60, max: 120 }, { lvl: 55, lvlreq: 40, freq: 2 }, M_ITS.CM32],
    ['R1', { code: 'ac-miss', min: 120, max: 150 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.CM3],
    ['R4', { code: 'ac-miss', min: 30, max: 60 }, { lvl: 10, lvlreq: 7, freq: 2 }, M_ITS.JEW],
    ['R3', { code: 'ac-miss', min: 50, max: 80 }, { lvl: 30, lvlreq: 15, freq: 2 }, M_ITS.JEW],
    ['R2', { code: 'ac-miss', min: 60, max: 100 }, { lvl: 50, lvlreq: 25, freq: 2 }, M_ITS.JEW],
    ['R1', { code: 'ac-miss', min: 80, max: 120 }, { lvl: 70, lvlreq: 45, freq: 2 }, M_ITS.JEW],
  ],
  'ac-hth': [
    ['R4', { code: 'ac-hth', min: 60, max: 80 }, { lvl: 15, lvlreq: 10, freq: 2 }, M_ITS.ARMO],
    ['R3', { code: 'ac-hth', min: 80, max: 120 }, { lvl: 35, lvlreq: 20, freq: 2 }, M_ITS.ARMO],
    ['R2', { code: 'ac-hth', min: 120, max: 160 }, { lvl: 55, lvlreq: 40, freq: 2 }, M_ITS.ARMO],
    ['R1', { code: 'ac-hth', min: 160, max: 200 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.ARMO],
    ['R4', { code: 'ac-hth', min: 60, max: 60 }, { lvl: 15, lvlreq: 10, freq: 2 }, M_ITS.CM321],
    ['R3', { code: 'ac-hth', min: 60, max: 90 }, { lvl: 35, lvlreq: 20, freq: 2 }, M_ITS.CM32],
    ['R2', { code: 'ac-hth', min: 90, max: 120 }, { lvl: 55, lvlreq: 40, freq: 2 }, M_ITS.CM32],
    ['R1', { code: 'ac-hth', min: 120, max: 150 }, { lvl: 75, lvlreq: 50, freq: 2 }, M_ITS.CM3],
    ['R4', { code: 'ac-hth', min: 30, max: 60 }, { lvl: 10, lvlreq: 7, freq: 2 }, M_ITS.JEW],
    ['R3', { code: 'ac-hth', min: 50, max: 80 }, { lvl: 30, lvlreq: 15, freq: 2 }, M_ITS.JEW],
    ['R2', { code: 'ac-hth', min: 60, max: 100 }, { lvl: 50, lvlreq: 25, freq: 2 }, M_ITS.JEW],
    ['R1', { code: 'ac-hth', min: 100, max: 120 }, { lvl: 70, lvlreq: 45, freq: 2 }, M_ITS.JEW],
  ],
  'super-ac': [
    ['R4', { code: 'ac', min: 60, max: 80 }, { lvl: 16, lvlreq: 12, freq: 2 }, M_ITS.ARMO],
    ['R3', { code: 'ac', min: 80, max: 100 }, { lvl: 36, lvlreq: 22, freq: 2 }, M_ITS.ARMO],
    ['R2', { code: 'ac', min: 100, max: 120 }, { lvl: 56, lvlreq: 42, freq: 2 }, M_ITS.ARMO],
    ['R1', { code: 'ac', min: 120, max: 150 }, { lvl: 76, lvlreq: 52, freq: 2 }, M_ITS.ARMO],
    ['R4', { code: 'ac', min: 40, max: 50 }, { lvl: 14, lvlreq: 11, freq: 2 }, M_ITS.CM321],
    ['R3', { code: 'ac', min: 50, max: 70 }, { lvl: 34, lvlreq: 21, freq: 2 }, M_ITS.CM32],
    ['R2', { code: 'ac', min: 70, max: 100 }, { lvl: 54, lvlreq: 41, freq: 2 }, M_ITS.CM32],
    ['R1', { code: 'ac', min: 100, max: 120 }, { lvl: 74, lvlreq: 51, freq: 2 }, M_ITS.CM3],
    ['R4', { code: 'ac', min: 20, max: 40 }, { lvl: 11, lvlreq: 7, freq: 2 }, M_ITS.JEW],
    ['R3', { code: 'ac', min: 40, max: 60 }, { lvl: 31, lvlreq: 14, freq: 2 }, M_ITS.JEW],
    ['R2', { code: 'ac', min: 60, max: 80 }, { lvl: 51, lvlreq: 26, freq: 2 }, M_ITS.JEW],
    ['R1', { code: 'ac', min: 80, max: 100 }, { lvl: 71, lvlreq: 43, freq: 2 }, M_ITS.JEW],
  ],
  'super-ac%': [
    ['R4', { code: 'ac%', min: 20, max: 30 }, { lvl: 15, lvlreq: 9, freq: 2 }, M_ITS.ARMO],
    ['R3', { code: 'ac%', min: 30, max: 40 }, { lvl: 35, lvlreq: 21, freq: 2 }, M_ITS.ARMO],
    ['R2', { code: 'ac%', min: 40, max: 50 }, { lvl: 55, lvlreq: 41, freq: 2 }, M_ITS.ARMO],
    ['R1', { code: 'ac%', min: 50, max: 60 }, { lvl: 75, lvlreq: 51, freq: 2 }, M_ITS.ARMO],
    ['R4', { code: 'ac%', min: 10, max: 15 }, { lvl: 12, lvlreq: 7, freq: 2 }, M_ITS.CM321_JEW],
    ['R3', { code: 'ac%', min: 15, max: 25 }, { lvl: 32, lvlreq: 15, freq: 2 }, M_ITS.CM32_JEW],
    ['R2', { code: 'ac%', min: 25, max: 35 }, { lvl: 52, lvlreq: 31, freq: 2 }, M_ITS.CM32_JEW],
    ['R1', { code: 'ac%', min: 35, max: 50 }, { lvl: 72, lvlreq: 41, freq: 2 }, M_ITS.CM3_JEW],
  ],
  'red-dmg': [
    ['R4', { code: 'red-dmg', min: 4, max: 6 }, { lvl: 13, lvlreq: 7, freq: 2 }, M_ITS.ARMO],
    ['R3', { code: 'red-dmg', min: 6, max: 8 }, { lvl: 40, lvlreq: 21, freq: 2 }, M_ITS.ARMO],
    ['R2', { code: 'red-dmg', min: 8, max: 10 }, { lvl: 62, lvlreq: 36, freq: 2 }, M_ITS.ARMO],
    ['R1', { code: 'red-dmg', min: 10, max: 12 }, { lvl: 73, lvlreq: 53, freq: 2 }, M_ITS.ARMO],
    ['R4', { code: 'red-dmg', min: 2, max: 4 }, { lvl: 14, lvlreq: 8, freq: 2 }, M_ITS.CM321_JEW],
    ['R3', { code: 'red-dmg', min: 3, max: 6 }, { lvl: 37, lvlreq: 19, freq: 2 }, M_ITS.CM32_JEW],
    ['R2', { code: 'red-dmg', min: 5, max: 8 }, { lvl: 57, lvlreq: 39, freq: 2 }, M_ITS.CM32_JEW],
    ['R1', { code: 'red-dmg', min: 8, max: 10 }, { lvl: 77, lvlreq: 49, freq: 2 }, M_ITS.CM3_JEW],
  ],
  'red-dmg%': [
    ['R4', { code: 'red-dmg%', min: 3, max: 6 }, { lvl: 15, lvlreq: 8, freq: 2 }, M_ITS.ARMO],
    ['R3', { code: 'red-dmg%', min: 6, max: 9 }, { lvl: 40, lvlreq: 21, freq: 2 }, M_ITS.ARMO],
    ['R2', { code: 'red-dmg%', min: 9, max: 12 }, { lvl: 62, lvlreq: 36, freq: 2 }, M_ITS.ARMO],
    ['R1', { code: 'red-dmg%', min: 12, max: 15 }, { lvl: 73, lvlreq: 53, freq: 2 }, M_ITS.ARMO],
    ['R4', { code: 'red-dmg%', min: 2, max: 4 }, { lvl: 17, lvlreq: 9, freq: 2 }, M_ITS.CM321_JEW],
    ['R3', { code: 'red-dmg%', min: 3, max: 6 }, { lvl: 37, lvlreq: 19, freq: 2 }, M_ITS.CM32_JEW],
    ['R2', { code: 'red-dmg%', min: 5, max: 9 }, { lvl: 57, lvlreq: 39, freq: 2 }, M_ITS.CM32_JEW],
    ['R1', { code: 'red-dmg%', min: 9, max: 12 }, { lvl: 77, lvlreq: 49, freq: 2 }, M_ITS.CM3_JEW],
  ],
  'red-mag': [
    ['R4', { code: 'red-mag', min: 4, max: 6 }, { lvl: 12, lvlreq: 6, freq: 2 }, M_ITS.ARMO],
    ['R3', { code: 'red-mag', min: 6, max: 8 }, { lvl: 40, lvlreq: 21, freq: 2 }, M_ITS.ARMO],
    ['R2', { code: 'red-mag', min: 8, max: 10 }, { lvl: 62, lvlreq: 36, freq: 2 }, M_ITS.ARMO],
    ['R1', { code: 'red-mag', min: 10, max: 12 }, { lvl: 73, lvlreq: 53, freq: 2 }, M_ITS.ARMO],
    ['R4', { code: 'red-mag', min: 2, max: 4 }, { lvl: 13, lvlreq: 7, freq: 2 }, M_ITS.CM321_JEW],
    ['R3', { code: 'red-mag', min: 3, max: 6 }, { lvl: 37, lvlreq: 19, freq: 2 }, M_ITS.CM32_JEW],
    ['R2', { code: 'red-mag', min: 5, max: 8 }, { lvl: 57, lvlreq: 39, freq: 2 }, M_ITS.CM32_JEW],
