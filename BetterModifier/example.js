...
// pushSuf(mss, setItypes(noRare(Modifier.twoMods(new ModBase("sorDualTabA", 211, 'sor'), skilltab3m, skilltab4m))), SOR_ITYPES);
// pushSuf(mss, setItypes(noRare(Modifier.twoMods(new ModBase("sorDualTabB", 211, 'sor'), skilltab3m, skilltab5m))), SOR_ITYPES);
// pushSuf(mss, setItypes(noRare(Modifier.twoMods(new ModBase("sorDualTabC", 211, 'sor'), skilltab4m, skilltab5m))), SOR_ITYPES);
...
const modebase1 = new ModBase("palDualTabA", 211, 'pal');
let modifer1 = Modifier.twoMods(modebase1, skilltab9m, skilltab10m)
const typeinput1=  ['scep', 'swor', 'mace', `shld`, `ashd`, `amul`, `circ`];
const typeinput2 = ['scha', 'mcha', 'lcha'];
noRare(modifer1);
setItypes(modifer1,typeinput1);
setItypes(modifer1,typeinput2);
setItypes(modifer1,['jewl', 'amul', 'ring']);
setItypes(modifer1,SOR_ITYPES);
pushSuf(mss, modifer1);
