...
skills.rows.forEach((row) => {
  ...
  if (row.skill === 'Charged Bolt') {
    ...
    row.Param8 = 10;//6 # Damage synergy	
    ...
    row.EMin = "6"; row.EMinLev1 = "1"; row.EMinLev2 = "2"; row.EMinLev3 = "4"; row.EMinLev4 = "5"; row.EMinLev5 = "6";
    row.EMax = "12"; row.EMaxLev1 = "4"; row.EMaxLev2 = "6"; row.EMaxLev3 = "8"; row.EMaxLev4 = "10"; row.EMaxLev5 = "12";
  }
